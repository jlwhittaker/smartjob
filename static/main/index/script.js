window.addEventListener("load", (e) => {
	...
	const update_live_search = function(search_results) {
		...
		for (let result of search_results) {
			...
			li.addEventListener("click", fill_live_search);
			list.appendChild(li);
		}
	}
	...
	const modal_hide_search = function() {
		...
		document.querySelector(".live_search_results ul").innerHTML = '';
	}
	...
	function see_all(e) {
		let choice = SELECTED.toLowerCase();
		window.location.href=`${choice}/all`;
	}
	...
	document.querySelector(".see_all").addEventListener("click", see_all);
});