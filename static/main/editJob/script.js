...
let getEstimateTasks = function(e) {
    ...
    .then((data) => {
        ...
        estimateNameLink.innerText = estimate_id;
...
let deleteJob = function(e) {
    if (confirm("Are you sure you want to delete this job? (This cannot be undone)")) {
        fetch(`/deleteJob/${JOB_ID}`).then((response) => {
...
window.addEventListener("load", (loadEvent) => {
    ...
    deleteJobPrompt.querySelectorAll("button")[0].addEventListener("click", deleteJob);
