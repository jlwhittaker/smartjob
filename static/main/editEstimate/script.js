...
let saveEstimate = function(e) {
    ...
    fetch(`/saveEstimate/${ESTIMATE_ID}`, {
        method: 'POST',
        headers: {
...
window.addEventListener("load", (loadEvent) => {
    ...
    let deleteJobBtn = document.querySelector(".delete-job-btn");
    let deleteJobPrompt = document.querySelector(".delete-job-prompt");
    deleteJobBtn.addEventListener("click", (e) => {
        deleteJobPrompt.classList.toggle("active");
    });

    deleteJobPrompt.querySelectorAll("button")[1].addEventListener("click", (e) => {
        deleteJobPrompt.classList.toggle("active");
    })

    deleteJobPrompt.querySelectorAll("button")[0].addEventListener("click", deleteEstimate);
