...
function deleteInvoice(e) {
    if (confirm("Are you sure you want to delete this job? (This cannot be undone)")) {
        fetch(`/deleteInvoice/${INVOICE_ID}`).then((response) => {
...
window.addEventListener("load", (loadEvent) => {
    ...
    let deleteInvoiceBtn = document.querySelector(".delete-invoice-btn");
    let deleteInvoicePrompt = document.querySelector(".delete-invoice-prompt");
    deleteInvoiceBtn.addEventListener("click", (e) => {
        deleteInvoicePrompt.classList.toggle("active");
    });

    deleteInvoicePrompt.querySelectorAll("button")[1].addEventListener("click", (e) => {
        deleteInvoicePrompt.classList.toggle("active");
    })

    deleteInvoicePrompt.querySelectorAll("button")[0].addEventListener("click", deleteInvoice);
