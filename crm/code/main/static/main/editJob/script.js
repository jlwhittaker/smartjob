...
window.addEventListener("load", (loadEvent) => {
    ...
    // Delete Job button clicked, prompt visiblity toggled
    document.querySelector(".delete-job-btn").addEventListener("click", handlers.deleteJobPrompt);

    // Cancelling toggles prompt visibility, other button deletes job
    let deleteJobPrompt = document.querySelector(".delete-job-prompt");
    deleteJobPrompt.querySelectorAll("button")[1].addEventListener("click", handlers.deleteJobPrompt);
    deleteJobPrompt.querySelectorAll("button")[0].addEventListener("click", handlers.deleteJob);
